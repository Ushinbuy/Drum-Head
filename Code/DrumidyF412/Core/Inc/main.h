...
#define DD3_Pin GPIO_PIN_4
#define DD3_GPIO_Port GPIOF
#define LCD_BLCTRL_Pin GPIO_PIN_5
#define LCD_BLCTRL_GPIO_Port GPIOF
#define DD5_Pin GPIO_PIN_10
#define DD5_GPIO_Port GPIOF
...
#define DD0_Pin GPIO_PIN_9
#define DD0_GPIO_Port GPIOG
#define DD4_Pin GPIO_PIN_12
#define DD4_GPIO_Port GPIOG
#define DD2_Pin GPIO_PIN_13
#define DD2_GPIO_Port GPIOG
#define DD1_Pin GPIO_PIN_14
#define DD1_GPIO_Port GPIOG
